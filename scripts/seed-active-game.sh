...
# Players
redis6-cli SADD players rtrigo0097_68051 tori_moravian_account mariama0252 ahmedsadeq11

# riley: lots of cash, a few safe picks
redis6-cli HSET portfolio:rtrigo0097_68051 cash 7500.00 AAPL 10 MSFT 5

# tori: spread across several stocks
redis6-cli HSET portfolio:tori_moravian_account cash 3200.00 GOOGL 3 NVDA 8 JPM 4

# mariama: big bet on TSLA
redis6-cli HSET portfolio:mariama0252 cash 1000.00 TSLA 12 META 2

# ahmed: mostly cash, one stock
redis6-cli HSET portfolio:ahmedsadeq11 cash 9100.00 AMZN 4
